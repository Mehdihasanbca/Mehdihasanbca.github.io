(()=>{
  ...
  // Normalize legacy presentation-poster references to the official brand mark.
  ...
  if(gridPages.has(path)){
    ...
    if(!gridStyle){
      gridStyle=document.createElement('link');
      gridStyle.rel='stylesheet';
      gridStyle.href='assets/avc-gridline.css?v=20260813-g1';
    }
    document.head.appendChild(gridStyle);
    if(!document.querySelector('script[data-avc-gridline-loader]')){
  ...
  const labels={
    'about.html':'About AVC','company-verification.html':'Company Verification','brochure.html':'Company Brochure',
    'resources.html':'Resources & Tools','knowledge.html':'Knowledge & FAQ Center','medical-booking.html':'Wafid Medical Booking Assistance',
    'payment-trust.html':'Payment Trust Center','payment-refund.html':'Payment & Refund Policy','candidate-readiness.html':'Candidate Readiness Checklist',
    'services.html':'Services','candidate-sourcing.html':'Candidate Sourcing','application-coordination.html':'Application Coordination',
    'cv-profile-support.html':'CV & Profile Support','document-guidance.html':'Document Guidance','interview-coordination.html':'Interview Coordination',
    'employer-manpower-support.html':'Employer Manpower Support','jobs.html':'Jobs','access.html':'Access Center','candidates.html':'Candidates',
    'employers.html':'Employers','employer-requirement.html':'Employer Requirement','partners.html':'Recruitment Partners','partner-enquiry.html':'Partner Enquiry',
    'office.html':'Office & Interview Support','media.html':'Media & Official Channels','trust-center.html':'Trust Center','contact.html':'Contact & Support',
    'fraud-safety.html':'Fraud Safety','privacy.html':'Privacy Policy','terms.html':'Terms','disclaimer.html':'Disclaimer'
  };
  if(labels[path]){
