(()=>{
  ...
  const labels={
    'about.html':'About AVC','company-verification.html':'Company Verification','brochure.html':'Company Brochure','resources.html':'Resources & Tools','candidate-readiness.html':'Candidate Readiness Checklist','services.html':'Services','candidate-sourcing.html':'Candidate Sourcing','application-coordination.html':'Application Coordination','cv-profile-support.html':'CV & Profile Support','document-guidance.html':'Document Guidance','interview-coordination.html':'Interview Coordination','employer-manpower-support.html':'Employer Manpower Support','jobs.html':'Jobs','access.html':'Access Center','candidates.html':'Candidates','employers.html':'Employers','employer-requirement.html':'Employer Requirement','partners.html':'Recruitment Partners','partner-enquiry.html':'Partner Enquiry','office.html':'Office & Interview Support','media.html':'Media & Official Channels','trust-center.html':'Trust Center','contact.html':'Contact & Support','fraud-safety.html':'Fraud Safety','privacy.html':'Privacy Policy','terms.html':'Terms','disclaimer.html':'Disclaimer'
  };
  if(labels[path]){
    graph.push({
      '@type':'BreadcrumbList',
